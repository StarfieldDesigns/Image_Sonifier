...
int getarguments(boxdata *data){
	...
	printf("Please enter the approximate number of colors in a selected piece of artwork:\n");
	scanf("%d", &data->numchanges);
	//printf("Please enter a midi note:\n");
	//scanf("%d", &data->midi_note);
	//printf("Enter a number 1 through 10:\n");
	//scanf("%d", &data->keychoice);
...
void csdbuild(boxdata *data){
	...
	double tmp = ((double)data->numchanges / 18) + 0.1;
    double gainChange;
    double panChange;
    int waveChange;
    int pluckChange;
